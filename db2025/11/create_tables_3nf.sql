...
-- job_master にコピー
INSERT INTO job_master (job_id, job_name)
SELECT job_id, name FROM job_names_tmp;

-- =============================================
-- character に job_id を均等割り当て
-- =============================================
...
SELECT
  p.person_id,
  p.person_id,
  ((p.person_id - 1) % (SELECT COUNT(*) FROM job_master)),
